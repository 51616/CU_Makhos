...
class Coach():
    ...
    def learn(self):
        ...
        for i in range(1, self.args.numIters+1):
            ...
            state_dict = self.nnet.nnet.state_dict().data.cpu().numpy()
            state_dict1 = self.nnet1.nnet.state_dict().data.cpu().numpy()
            print(state_dict == state_dict1)
            state_dict2 = self.nnet2.nnet.state_dict().data.cpu().numpy()
            print(state_dict == state_dict2)
            state_dict3 = self.nnet3.nnet.state_dict().data.cpu().numpy()
